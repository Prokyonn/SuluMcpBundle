...
/**
 * Asserts MediaListTool's real return value against its declared outputSchema.
 */
...
final class MediaListToolOutputSchemaTest extends TestCase
{
    ...
    /**
     * Exercises the "hint" branch: per-collection ACLs filter a row out, so the
     * unfiltered `total` exceeds the visible items and a hint is appended.
     */
