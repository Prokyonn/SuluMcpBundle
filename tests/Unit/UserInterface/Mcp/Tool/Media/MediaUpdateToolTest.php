...
final class MediaUpdateToolTest extends TestCase
{
    ...
    /**
     * The tool narrows the token's user with `instanceof User`, and the value
     * returned by getId() is asserted downstream (passed as save()'s userId),
     * so a real User is subclassed here only to make that id settable --
     * User's own id property has no setter (Doctrine-generated identity).
     */
