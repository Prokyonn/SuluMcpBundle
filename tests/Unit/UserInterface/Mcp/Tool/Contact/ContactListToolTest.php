...
final class ContactListToolTest extends TestCase
{
    ...
    {
        $this->accountRepository->findAllSelect(Argument::cetera())
    ...
    {
        $this->contactRepository->findGetAll(Argument::cetera())
            ->willThrow(new \RuntimeException('Bundle not installed'));
