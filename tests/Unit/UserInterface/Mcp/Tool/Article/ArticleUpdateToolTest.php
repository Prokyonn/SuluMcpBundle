...
final class ArticleUpdateToolTest extends TestCase
{
    ...
    /**
     * Prophecy promise for MessageBusInterface::dispatch() mimicking Sulu's real
     * synchronous dispatch: attach a HandledStamp wrapping $article to whatever
     * envelope was actually passed in.
     */
    ...
    /** Real dimension content carrying a fixed template key, standing in for the current article state. */
