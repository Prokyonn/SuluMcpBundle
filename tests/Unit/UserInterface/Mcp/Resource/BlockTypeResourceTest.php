...
/**
 * Covers BlocksResource's own orchestration: discovering block fields (including
 * inside sections), deduplicating block types across content types, resolving a
 * `<type ref="…"/>` (global block) to its real field list before generating a
 * schema for it, and the available_in_templates bookkeeping. Schema generation
 * itself is SchemaMetadataAdapter's job, covered in SchemaMetadataAdapterTest.
 */
...
final class BlockTypeResourceTest extends TestCase
{
    ...
    public function testGetBlocksDeduplicatesBlockTypesAcrossTemplates(): void
    {
        ...
        // Only generated once, despite being used in two templates.
    ...
    {
        // <type ref="heading"/>: empty items, tagged sulu.global_block.
        ...
        // The real global block, with an actual field.
        ...
        // The generator was called with the *resolved* global block's items, not
        // the empty ref placeholder's.
    ...
    public function testGetBlocksUsesInlineItemsWhenTypeIsNotTaggedGlobal(): void
    {
        ...
        // No 'block' key ever queried — proves inline (non-ref) types don't
        // trigger a global block lookup.
