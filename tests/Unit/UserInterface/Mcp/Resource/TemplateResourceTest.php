...
/**
 * Covers TemplatesResource's own orchestration (which content types it scans,
 * how it groups/envelopes the result). Schema generation itself — section
 * flattening, block type resolution, x-sulu-type annotation, definitions — is
 * SchemaMetadataAdapter's job and is covered in SchemaMetadataAdapterTest.
 */
...
final class TemplateResourceTest extends TestCase
{
    ...
    public function testGetTemplatesEnvelopeIncludesKeyLabelAndGeneratedSchema(): void
    {
        ...
        // Schema is whatever the generator produced — proves the generator was
        // actually invoked and its result passed through untouched.
    ...
    {
        // TemplatesResource no longer flattens sections itself — it hands the
        // form's items straight to the generator, sections included.
        $field = new FieldMetadata('title');
        $field->setType('text_line');
