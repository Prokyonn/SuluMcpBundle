...
final class WebspaceResourceTest extends TestCase
{
    ...
    public function testGetWebspacesReturnsAllWebspacesWithLocalesAndUrl(): void
    {
        ...
        $this->webspaceManager->getWebspaceCollection()->willReturn(new WebspaceCollection([$ws1, $ws2]));
    ...
    public function testGetWebspacesFiltersToMainEnvironmentUrl(): void
    {
        ...
        $this->webspaceManager->getWebspaceCollection()->willReturn(new WebspaceCollection([$ws]));
    ...
    {
        $localizations = \array_map(static fn (string $locale) => new Localization($locale), $locales);
