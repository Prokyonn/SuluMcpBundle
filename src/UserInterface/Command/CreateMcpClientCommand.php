...
class CreateMcpClientCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        // --scope is declared VALUE_IS_ARRAY, so Console always hands back an array of
        // non-empty strings here; InputInterface::getOption() itself only declares `mixed`.
    ...
    private function resolveClient(InputInterface $input, SymfonyStyle $io): ?string
    {
        ...
        // choice() only declares `mixed` -- passed a plain list of string choices without
        // multiselect, it always returns one of them.
    ...
    private function askRedirectUri(SymfonyStyle $io, string $question): string
    {
        ...
        // SymfonyStyle::ask() only declares `mixed` -- the validator above guarantees a
        // non-empty string or throws, so this always holds.
