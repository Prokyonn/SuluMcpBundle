    ...
    #[McpTool(
        ...
        outputSchema: [
            ...
            'properties' => [
                ...
                'limit' => ['type' => 'integer'],
                'page' => ['type' => 'integer'],
                // Present only when per-collection ACLs filtered rows out of "total".
                'hint' => OutputSchema::HINT_PROPERTY,
            ],
            // This tool has a single return path (permission failures throw instead
            // of returning), so these four are always present.
