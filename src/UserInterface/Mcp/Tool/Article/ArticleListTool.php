...
class ArticleListTool
{
    ...
    // Fields DimensionContentQueryEnhancer::addSortBys() actually honors — the
    // ArticleRepositoryInterface docblock only lists id/title, but the real
    // implementation orders by these too (title/authored/workflowPublished on the
    // dimension content, created/changed on the article entity itself).
